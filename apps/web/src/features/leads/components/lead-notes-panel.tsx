...
export function LeadNotesPanel({ leadId }: LeadNotesPanelProps): React.ReactElement {
  const { notes, isLoading, createNote, isCreating, deleteNote, updateNote } = useLeadNotes(leadId);
  ...
  async function onSubmit(values: NoteFormValues): Promise<void> {
